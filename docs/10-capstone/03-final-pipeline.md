...
Create `src/kubeflow_by_doing/registry.py`:
...
!!! warning
    ...
    Codex should harden this file against the installed KFP SDK. In particular, verify `kubernetes.use_secret_as_env`, `set_service_account_name`, accelerator methods, and conditional syntax.
...
- KFP SDK compatibility issues are resolved by Codex
