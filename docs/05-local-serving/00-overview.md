...
!!! note
    ...
    This chapter package contains documentation only. All code, manifests, and commands are defined inline in the docs so the tutorial reader, or Codex, can create them in the repository.
